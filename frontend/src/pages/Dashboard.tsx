    ...
    <div className={dashboardClass}>
      <div id="header" className={`fixed top-0 left-0 right-0 z-40 ${config.dashBg} ${config.dashFrom} ${config.dashTo} ${config.dashVia ? config.dashVia : ''} flex flex-col`}>
        ...
        <div className="max-w-7xl lg:max-w-8xl mx-auto px-3 md:px-6 lg:px-8 w-full">
          ...
          <div className={`max-w-7xl lg:max-w-8xl mx-auto px-3 md:px-6 lg:px-8 w-full mt-2 md:mt-3 lg:mt-4 pt-4 md:pt-6 lg:pt-8 pb-4 md:pb-6 lg:pb-8 mb-3 md:mb-4 lg:mb-5 flex items-center justify-center gap-3 md:gap-4 rounded-xl md:rounded-2xl transition-all ${
            isDarkTheme
          ...
          <div className="lg:col-span-3 space-y-6 md:space-y-8 lg:space-y-10 scroll-smooth">
            ...
            <div className="-mt-4 md:-mt-6">
              <DayNavigator 
                ...
                label={period === 'today' ? getDateLabel(dayOffset) : getPeriodLabel()}
                period={period}
              />
            </div>
