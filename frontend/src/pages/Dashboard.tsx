    ...
    <div className={dashboardClass}>
      ...
      <div className={`fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-2xl transition-transform duration-300 z-50 ${calcExpanded ? 'translate-y-0' : 'translate-y-[calc(100%-4rem)]'}`} data-tour="calculator">
        <button
          ...
          className="w-full py-4 px-4 flex items-center justify-between bg-yellow-500 text-black font-bold text-lg hover:bg-yellow-600 opacity-100 shadow-lg"
        >
          ...
          {entryFormStep === 0 && (
            <>
              ...
              <button
                ...
                className="w-full bg-yellow-500 hover:bg-yellow-600 text-black py-4 rounded-lg text-lg font-bold mb-6"
              >
                Next Step →
              </button>
            </>
            ...
            <>
              ...
              <div className="flex gap-3 mt-4 mb-6">
                <button
                  ...
                  className="flex-1 bg-yellow-500 hover:bg-yellow-600 text-black py-4 rounded-lg text-lg font-bold"
                >
                  ← Back
                </button>
                <button
