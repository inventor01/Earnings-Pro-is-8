        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-10 mb-4 md:mb-8 lg:mb-10">
          ...
          <div className="lg:col-span-3 space-y-6 md:space-y-8 lg:space-y-10 scroll-smooth" data-tour="performance">
            ...
            <div className="flex items-center justify-between gap-2" id="performance-overview">
              <h2 className={`flex items-center gap-3 text-2xl md:text-3xl font-bold drop-shadow-2xl ${isDarkTheme ? 'text-green-500' : 'text-slate-700'}`} style={isDarkTheme ? {textShadow: '0 0 20px rgba(34, 197, 94, 0.6), 0 0 40px rgba(34, 197, 94, 0.3), 0 4px 12px rgba(0, 0, 0, 0.8)'} : {}}>
                <svg className="w-8 h-8 md:w-10 md:h-10" fill="currentColor" viewBox="0 0 24 24" style={isDarkTheme ? {filter: 'drop-shadow(0 0 12px rgba(34, 197, 94, 0.5))'} : {}}>
