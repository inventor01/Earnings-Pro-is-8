...
export const THEMES: Record<ThemeName, ThemeConfig> = {
  ...
  'ninja-green': {
    ...
    dashFrom: 'from-emerald-900',
    dashTo: 'to-green-900',
    dashVia: 'via-green-800',
    
    kpiColors: {
      green: { glow: 'from-lime-200 to-lime-400', accent: 'text-lime-200', border: 'border-lime-300', bg: 'bg-lime-900/30' },
      red: { glow: 'from-red-400 to-red-600', accent: 'text-red-300', border: 'border-red-500', bg: 'bg-red-900/20' },
      blue: { glow: 'from-blue-400 to-blue-600', accent: 'text-blue-300', border: 'border-blue-500', bg: 'bg-blue-900/20' },
      purple: { glow: 'from-purple-400 to-purple-600', accent: 'text-purple-300', border: 'border-purple-500', bg: 'bg-purple-900/20' },
      orange: { glow: 'from-yellow-300 to-yellow-500', accent: 'text-yellow-300', border: 'border-yellow-500', bg: 'bg-yellow-900/20' },
      gray: { glow: 'from-gray-400 to-gray-600', accent: 'text-gray-300', border: 'border-gray-500', bg: 'bg-gray-800/20' },
    },
    
    titleColor: 'text-transparent bg-clip-text bg-gradient-to-r from-lime-200 via-lime-300 to-green-400',
    textPrimary: 'text-lime-200',
    textSecondary: 'text-lime-300',
    
    chipInactive: 'bg-green-900 text-lime-100 border border-green-700',
    chipActive: 'text-green-950',
    chipActiveBg: 'bg-gradient-to-r from-lime-200 to-yellow-300',
    
    tableBg: 'bg-green-900/40 border border-lime-600',
    tableHeader: 'bg-green-800/60 border-b border-lime-600',
    tableHeaderText: 'text-lime-200',
    tableRow: 'text-lime-100',
    tableRowHover: 'hover:bg-green-800/40',
    tableRowSelected: 'bg-lime-300/15 border-l-2 border-lime-200',
    
    buttonPrimary: 'bg-gradient-to-r from-lime-300 to-yellow-400 hover:from-lime-200 hover:to-yellow-300',
    buttonPrimaryText: 'text-green-950 font-bold',
    
    textGreen: 'text-lime-200',
    textRed: 'text-red-300',
    textCyan: 'text-lime-200',
  },
};
