...
export const THEMES: Record<ThemeName, ThemeConfig> = {
  ...
  'ninja-green': {
    ...
    kpiColors: {
      green: { glow: 'from-lime-300 to-green-500', accent: 'text-green-700', border: 'border-green-300', bg: 'bg-green-50' },
      red: { glow: 'from-red-400 to-red-600', accent: 'text-red-700', border: 'border-red-300', bg: 'bg-red-50' },
      blue: { glow: 'from-blue-400 to-blue-600', accent: 'text-blue-700', border: 'border-blue-300', bg: 'bg-blue-50' },
      purple: { glow: 'from-purple-400 to-purple-600', accent: 'text-purple-700', border: 'border-purple-300', bg: 'bg-purple-50' },
      orange: { glow: 'from-yellow-300 to-yellow-500', accent: 'text-yellow-700', border: 'border-yellow-300', bg: 'bg-yellow-50' },
      gray: { glow: 'from-gray-400 to-gray-600', accent: 'text-gray-700', border: 'border-gray-300', bg: 'bg-gray-50' },
    },
    
    titleColor: 'text-transparent bg-clip-text bg-gradient-to-r from-green-700 via-green-600 to-emerald-700',
    textPrimary: 'text-green-800',
    textSecondary: 'text-green-700',
    
    chipInactive: 'bg-gray-200 text-gray-700 border border-gray-400',
    chipActive: 'text-white',
    chipActiveBg: 'bg-gradient-to-r from-green-600 to-emerald-600',
    
    tableBg: 'bg-white border border-green-300',
    tableHeader: 'bg-green-100 border-b border-green-400',
    tableHeaderText: 'text-green-800',
    tableRow: 'text-gray-900',
    tableRowHover: 'hover:bg-yellow-50',
    tableRowSelected: 'bg-lime-100 border-l-2 border-green-600',
    
    buttonPrimary: 'bg-gradient-to-r from-green-600 to-emerald-700 hover:from-green-700 hover:to-emerald-800',
    buttonPrimaryText: 'text-white font-bold',
    
    textGreen: 'text-green-700',
    textRed: 'text-red-700',
    textCyan: 'text-green-700',
  },
};
