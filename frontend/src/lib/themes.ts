...
export const THEMES: Record<ThemeName, ThemeConfig> = {
  ...
  'ninja-green': {
    ...
    kpiColors: {
      ...
      red: { glow: 'from-red-400 to-red-600', accent: 'text-red-800', border: 'border-red-400', bg: 'bg-red-50' },
      blue: { glow: 'from-blue-400 to-blue-600', accent: 'text-blue-800', border: 'border-blue-400', bg: 'bg-blue-50' },
      purple: { glow: 'from-purple-400 to-purple-600', accent: 'text-purple-800', border: 'border-purple-400', bg: 'bg-purple-50' },
      orange: { glow: 'from-yellow-400 to-yellow-600', accent: 'text-yellow-800', border: 'border-yellow-500', bg: 'bg-yellow-50' },
      gray: { glow: 'from-gray-400 to-gray-600', accent: 'text-gray-800', border: 'border-gray-400', bg: 'bg-gray-50' },
    },
    
    titleColor: 'text-transparent bg-clip-text bg-gradient-to-r from-lime-500 via-green-700 to-lime-600',
    textPrimary: 'text-green-800',
    textSecondary: 'text-lime-600',
    
    chipInactive: 'bg-lime-100 text-green-800 border border-lime-400',
    chipActive: 'text-white',
    chipActiveBg: 'bg-gradient-to-r from-lime-500 to-green-700',
    
    tableBg: 'bg-white border border-lime-400',
    tableHeader: 'bg-lime-100 border-b border-lime-400',
    tableHeaderText: 'text-green-800',
    tableRow: 'text-gray-900',
    tableRowHover: 'hover:bg-lime-50',
    tableRowSelected: 'bg-lime-100 border-l-2 border-lime-500',
    
    buttonPrimary: 'bg-gradient-to-r from-lime-500 to-green-700 hover:from-lime-600 hover:to-green-800',
    buttonPrimaryText: 'text-white font-bold',
    
    textGreen: 'text-lime-600',
    textRed: 'text-red-700',
    textCyan: 'text-lime-600',
  },
};
