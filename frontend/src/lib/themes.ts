...
export const THEMES: Record<ThemeName, ThemeConfig> = {
  ...
  'ninja-green': {
    ...
    dashFrom: 'from-lime-50',
    dashTo: 'to-green-50',
    dashVia: 'via-emerald-50',
    
    kpiColors: {
      green: { glow: 'from-green-400 to-emerald-600', accent: 'text-green-600', border: 'border-green-300', bg: 'bg-green-50' },
      red: { glow: 'from-red-400 to-red-600', accent: 'text-red-600', border: 'border-red-200', bg: 'bg-red-50' },
      blue: { glow: 'from-blue-400 to-blue-600', accent: 'text-blue-600', border: 'border-blue-200', bg: 'bg-blue-50' },
      purple: { glow: 'from-purple-400 to-purple-600', accent: 'text-purple-600', border: 'border-purple-200', bg: 'bg-purple-50' },
      orange: { glow: 'from-yellow-400 to-yellow-600', accent: 'text-yellow-600', border: 'border-yellow-200', bg: 'bg-yellow-50' },
      gray: { glow: 'from-gray-400 to-gray-600', accent: 'text-gray-700', border: 'border-gray-200', bg: 'bg-gray-50' },
    },
    
    titleColor: 'text-transparent bg-clip-text bg-gradient-to-r from-green-600 via-emerald-600 to-green-700',
    textPrimary: 'text-green-700',
    textSecondary: 'text-green-600',
    
    chipInactive: 'bg-gray-100 text-gray-700 border border-gray-300',
    chipActive: 'text-white',
    chipActiveBg: 'bg-gradient-to-r from-green-500 to-emerald-600',
    
    tableBg: 'bg-white border border-green-200',
    tableHeader: 'bg-green-50 border-b border-green-300',
    tableHeaderText: 'text-green-700',
    tableRow: 'text-gray-800',
    tableRowHover: 'hover:bg-green-50',
    tableRowSelected: 'bg-green-100 border-l-2 border-green-500',
