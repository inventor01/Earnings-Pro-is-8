...
export const THEMES: Record<ThemeName, ThemeConfig> = {
  ...
  'ninja-green': {
    ...
    kpiColors: {
      ...
      blue: { glow: 'from-lime-400 to-green-700', accent: 'text-green-900', border: 'border-lime-500', bg: 'bg-lime-100' },
    ...
    titleColor: 'text-transparent bg-clip-text bg-gradient-to-r from-lime-400 via-green-800 to-lime-500',
    textPrimary: 'text-green-900',
    textSecondary: 'text-lime-600',
    
    chipInactive: 'bg-lime-100 text-green-900 border border-lime-500',
    chipActive: 'text-white',
    chipActiveBg: 'bg-gradient-to-r from-lime-400 to-green-800',
    ...
    tableRowHover: 'hover:bg-lime-100',
    tableRowSelected: 'bg-lime-200 border-l-4 border-lime-600',
    
    buttonPrimary: 'bg-gradient-to-r from-lime-400 to-green-800 hover:from-lime-500 hover:to-green-900',
