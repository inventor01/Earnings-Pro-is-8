              ...
              {showDayNav && onDayChange && getDateLabel && (
                <>
                  <button
                    ...
                    className="p-1.5 md:p-2 rounded-lg transition-all bg-lime-600 text-white hover:bg-lime-700 font-bold text-sm md:text-base"
                    title="Previous day"
                  >
                    ←
                  </button>
                  <div className="px-3 py-1 md:px-4 md:py-1.5 rounded-lg font-bold text-xs md:text-sm whitespace-nowrap bg-lime-100 text-lime-900 border border-lime-400">
