            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
              {achievements.badges.map((badge, idx) => (
                ...
                >
                  ...
                  {badge.icon === 'star' && <svg className={`w-5 h-5 sm:w-6 sm:h-6 ${badge.color} mx-auto mb-1 md:mr-3`} fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>}
