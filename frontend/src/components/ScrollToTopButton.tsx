  ...
  return (
    <>
        ...
        <button
          ...
          className={`fixed right-3 md:right-5 bottom-40 md:bottom-56 z-50 p-2 md:p-3 rounded-full shadow-lg transition-all active:scale-95 active:opacity-100 hover:opacity-100 opacity-40 md:hover:scale-110 touch-action-manipulation ${
            isDarkTheme
