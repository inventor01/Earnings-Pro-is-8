...
export function EntriesTable({ entries, onDelete, onEdit, onView, selectedIds = [], onSelectChange, period }: EntriesTableProps) {
  ...
  const getTypeIcon = (type: string) => {
    const iconMap: Record<string, string> = {
      ...
      'EXPENSE': 'M20.57 14.76L22 13.33c1.17-1.17 1.17-3.07 0-4.24l-4.24-4.24c-1.17-1.17-3.07-1.17-4.24 0l-1.43 1.43-2.48-2.48c-.78-.78-2.05-.78-2.83 0l-7.07 7.07c-.78.78-.78 2.05 0 2.83l7.07 7.07c.78.78 2.05.78 2.83 0l2.48-2.48 1.43 1.43c1.17 1.17 3.07 1.17 4.24 0l4.24-4.24c1.17-1.17 1.17-3.07 0-4.24z',
