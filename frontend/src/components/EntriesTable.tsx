...
export function EntriesTable({ entries, onDelete, onEdit, onView, selectedIds = [], onSelectChange, period }: EntriesTableProps) {
  ...
  const getCategoryIcon = (category: string) => {
    const iconMap: Record<string, string> = {
      'GAS': 'M19 9h-1V7c0-1.1-.9-2-2-2h-2V4c0-.55-.45-1-1-1h-4c-.55 0-1 .45-1 1v1H8c-1.1 0-2 .9-2 2v2H5c-.55 0-1 .45-1 1v8c0 .55.45 1 1 1h2c.55 0 1-.45 1-1v-2h12v2c0 .55.45 1 1 1h2c.55 0 1-.45 1-1v-8c0-.55-.45-1-1-1zM9 5h6v2H9V5z',
