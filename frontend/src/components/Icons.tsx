export const Icons = {
  ...
  Miles: (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
      <path d="M7 18c-.5 1.5-1 2-1 3 0 1.5 2 3 5 3s5-1.5 5-3c0-1-1-1.5-1-3" />
      <path d="M9 2h6v8H9z" />
      <rect x="8" y="10" width="8" height="6" />
      <path d="M7 18h10M6 18l1 3h8l1-3" />
    </svg>
  ),
  
  Orders: (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
      <path d="M6 2L4 6v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6l-2-4H6z" />
      <rect x="8" y="9" width="8" height="5" />
      <path d="M10 9v-2M14 9v-2" />
    </svg>
  ),
