...
**How to apply:** in the auto-start effect, right where the welcome phase is set for a production (non-demo) account, persist the flag; demo accounts never persist.
